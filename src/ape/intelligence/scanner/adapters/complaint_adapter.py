...
class ComplaintAdapter:
    ...
    def process_mock_result(self, raw_text: str) -> BusinessEvidence:
        pain = True if "şikayet" in raw_text.lower() or "kötü" in raw_text.lower() else UNKNOWN
        
        prov = EvidenceProvenance(source_adapter="complaint", raw_observation=raw_text)
